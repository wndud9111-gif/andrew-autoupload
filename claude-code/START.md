...
네이버 블로그는 Claude in Chrome에서 이동이 거부될 수 있습니다. macOS라면 ego lite를 설치하고 ego-browser 스킬을 함께 두면 네이버와 인스타그램을 ego lite 경로로 진행합니다. Windows에서는 네이버 자동 입력을 지원하지 않으며 원고를 직접 붙여넣어야 합니다.
